...
var LoginAddressChoose = {
    ...
    fn: function (thisJson,details) {
        ...
        var _this=this;
        _this.showaddress=details.addressPart||1;//判断当前是否将地址分开显示(true-分开；false-不分开)
        ...
        function fatherEleClick(evt) {
            ...
            if (this.className.indexOf('show') > -1) {
                ...
                if (thisData.length>0) {
                    ...
                    wrightHtmlOne.innerHTML=thisCityAll[thisAddressLength-2];

                    wrightHtmlTwo.innerHTML=thisCityAll[thisAddressLength-1];
